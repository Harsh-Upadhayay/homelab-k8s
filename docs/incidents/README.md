...
| [INC-2026-009](./INC-2026-009-jobhunt-mysql-binlog-volume-exhaustion.md) | 2026-09-08 | SEV-3 | job-hunt / MySQL / Longhorn | Thirty days of MySQL binary logs filled an 8Gi volume, hanging every InnoDB commit until the connection pool exhausted and Django crash-looped | Resolved; binlog retention open |
