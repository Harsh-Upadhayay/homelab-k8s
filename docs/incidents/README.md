...
| [INC-2026-006](./INC-2026-006-inotify-instance-pool-exhaustion.md) | 2026-08-12 | SEV-4 | All k3s nodes / kubelet | Stock `fs.inotify.max_user_instances=128` was shared per-node across kubelet and every pod, near exhaustion | Resolved |
