...
| [INC-2026-004](./INC-2026-004-argocd-repo-server-oom-recovery.md) | 2026-07-25 | SEV-3 | Argo CD / GitOps | Cold-cache Helm reconciliation repeatedly OOM-killed the repository server | Mitigated; validation in progress |
| [INC-2026-005](./INC-2026-005-prometheus-tsdb-capacity-exhaustion.md) | 2026-07-25 | SEV-3 | Prometheus / Longhorn | A full 10 GiB TSDB volume crash-looped Prometheus during WAL replay | Mitigated; recovery in progress |
