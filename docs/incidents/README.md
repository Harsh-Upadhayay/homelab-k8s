...
| [INC-2026-008](./INC-2026-008-gpu-install-exhausted-worker3-ephemeral-storage.md) | 2026-09-06 | SEV-3 | `k3s-worker-3` / Immich / photos-relay / workbench / GPU Operator | The NVIDIA driver and GPU Operator images crossed the kubelet eviction threshold on a 40 GiB OS disk, evicting 18 unrelated pods because none declare `ephemeral-storage` requests | Resolved; prevention open |
| [INC-2026-009](./INC-2026-009-jobhunt-mysql-binlog-volume-exhaustion.md) | 2026-09-08 | SEV-3 | job-hunt / MySQL / Longhorn | Thirty days of MySQL binary logs filled an 8Gi volume, hanging every InnoDB commit until the connection pool exhausted and Django crash-looped; Prometheus fired correctly but Alertmanager discarded every alert | Resolved; alert delivery open (#92) |
| [INC-2026-010](./INC-2026-010-pve-dell-outage-single-replica-workbench-outage.md) | 2026-09-12 | SEV-3 | `pve-dell` / `k3s-worker-1` / Longhorn / workbench | A hypervisor outage faulted every single-replica volume on one worker and correctly-fired alerts were discarded, so it ran 47 hours; the replica-count remediation was then applied to a hot volume, shutting down its ext4 filesystem for a further 20 hours | Resolved; alert delivery (#92), RWO co-scheduling, and host root cause open |
